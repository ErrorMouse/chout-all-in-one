...
if ( ! class_exists( 'Chout_AIO_Block_IPs' ) ) {
	final class Chout_AIO_Block_IPs {
		...
		const AIO_IPS_URL          = 'https://raw.githubusercontent.com/ErrorMouse/chout-all-in-one/refs/heads/main/List-Block-IPs.txt'; // phpcs:ignore PluginCheck.CodeAnalysis.Offloading.OffloadedContent
