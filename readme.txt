...
* Feature: Added real-time 'Block History' table tracking blocked IPs, timestamps, URLs and User Agents.

= 1.1.6 =

* Tweak: Reduced the AIO Block IPs auto-update interval from 24 hours to every 6 hours for more up-to-date protection.
